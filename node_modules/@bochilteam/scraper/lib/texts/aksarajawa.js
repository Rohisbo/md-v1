        ...
        while (i < this.str.length) {
            if (i > 0 && isVowel(this.str[i]) && isVowel(this.str[i - 1])) { //deal with words that start with multiple vocals
                if ((this.str[i - 1] == 'a' && this.str[i] == 'a') ||
                    ...
                    (this.str[i - 1] == 'a' && this.str[i] == 'u')) { //specials
                ...
                else if ((this.str[i - 1] == 'e' || this.str[i - 1] == 'è' || this.str[i - 1] == 'é') &&
                    (this.str[i] == 'a' || this.str[i] == 'o')) { //-y-
                    this.str = this.str.substring(0, i) + 'y' + this.str.substring(i, this.str.length);
                }
                else if ((this.str[i - 1] == 'i') &&
                    (this.str[i] == 'a' || this.str[i] == 'e' || this.str[i] == 'è' || this.str[i] == 'é' || this.str[i] == 'o' || this.str[i] == 'u')) { //-y-
                    this.str = this.str.substring(0, i) + 'y' + this.str.substring(i, this.str.length);
                }
                else if ((this.str[i - 1] == 'o') &&
                    (this.str[i] == 'a' || this.str[i] == 'e' || this.str[i] == 'è' || this.str[i] == 'é')) { //-w-
                    this.str = this.str.substring(0, i) + 'w' + this.str.substring(i, this.str.length);
                }
                else if ((this.str[i - 1] == 'u') &&
                    (this.str[i] == 'a' || this.str[i] == 'e' || this.str[i] == 'è' || this.str[i] == 'é' || this.str[i] == 'i' || this.str[i] == 'o')) { //-y-
                    this.str = this.str.substring(0, i) + 'w' + this.str.substring(i, this.str.length);
                }
                else {
                    this.str = this.str.substring(0, i) + 'h' + this.str.substring(i, this.str.length);
    ...
    GetSound(str) {
        ...
        if (str.length == 1)
            ...
            if (this.str2.indexOf("nggr") == 0) { //nggr-
                if (this.vowelPrev)
                    konsonan = "ꦁ​ꦒꦿ"; //<vowel>nggr-, e.g. panggrahita
                //else if (matra = "")
                else
                ...
                if (this.vowelPrev)
                    konsonan = "ꦁ​ꦒ"; //<vowel>ngg-, e.g. tunggal
            ...
            if (!regexp_file[this.str[i]]) { //not Aksara Jawa
                ...
                if (this.str[i] == "ꦴ" ||
                    ...
                    if (i > 0 && this.str[i - 1] == "꧊") {
                        ...
                        else if (this.str[i] == "ꦕ" ||
                            this.str[i] == "ꦖ") {
                            trans = ganti(j, "Ca", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦢ" ||
                            this.str[i] == "ꦣ") {
                            trans = ganti(j, "Da", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦒ" ||
                            this.str[i] == "ꦓ") {
                        ...
                        else if (this.str[i] == "ꦤ" ||
                            this.str[i] == "ꦟ") {
                            trans = ganti(j, "Na", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦥ" ||
                            this.str[i] == "ꦦ") {
                            trans = ganti(j, "Pa", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦫ" ||
                            this.str[i] == "ꦬ") {
                            trans = ganti(j, "Ra", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦱ" ||
                            this.str[i] == "ꦯ") {
                            trans = ganti(j, "Sa", trans);
                            j += 2;
                        }
                        else if (this.str[i] == "ꦠ" ||
                            this.str[i] == "ꦡ") {
                        ...
                        this.str[i] == "ꦲ" &&
                        this.str[i - 1] == "ꦃ") { //double hh
                        trans = ganti(j, "a", trans);
                        j++;
                    }
                    else if (i > 0 &&
                        this.str[i] == "ꦫ" &&
                        this.str[i - 1] == "ꦂ") { //double rr
                        trans = ganti(j, "a", trans);
                        j++;
                    }
                    else if (i > 0 &&
                        this.str[i] == "ꦔ" &&
                        this.str[i - 1] == "ꦁ") { //double ngng
                        trans = ganti(j, "a", trans);
                        j++;
                    }
                    else if (i > 1 &&
                        ...
                        (i == 0 ||
                            [" ", "​", "꧀", "꦳", "ꦴ", "ꦶ", "ꦷ", "ꦸ", "ꦹ", "ꦺ", "ꦻ", "ꦼ", "ꦽ", "ꦾ", "ꦿ"].indexOf(this.str[i - 1]) >= 0)) { //ha, preceeded by space or zws or open vowel
                    ...
                    this.str[i] == "ꦝ" ||
                    this.str[i] == "ꦞ" ||
                    this.str[i] == "ꦋ") { //nga, nya, tha, dha
                    if (i > 0 && this.str[i - 1] == "꧊") {
                        if (this.str[i] == "ꦔ") {
                            trans = ganti(j, "Nga", trans);
                            j += 3;
                        }
                        else if (this.str[i] == "ꦚ" ||
                            this.str[i] == "ꦘ") {
                            trans = ganti(j, "Nya", trans);
                            j += 3;
                        }
                        else if (this.str[i] == "ꦛ" ||
                            this.str[i] == "ꦜ") {
                            trans = ganti(j, "Tha", trans);
                            j += 3;
                        }
                        else if (this.str[i] == "ꦝ" ||
                            this.str[i] == "ꦞ") {
