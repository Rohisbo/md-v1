...
async function twitterdl(url) {
    ...
    const res = await (0, node_fetch_1.default)('https://www.expertsphp.com/instagram-reels-downloader.php', {
        method: 'POST',
...
async function twitterdlv2(url) {
    const resToken = await (0, node_fetch_1.default)('https://twittervideodownloader.com/', {
        headers: {
    ...
    const $ = cheerio_1.default.load(await resToken.text());
    const payload = {
        csrfmiddlewaretoken: $('input[name="csrfmiddlewaretoken"]').val(),
        tweet: url
    };
    const res = await (0, node_fetch_1.default)('https://twittervideodownloader.com/download', {
        method: 'POST',
        body: new URLSearchParams(Object.entries(payload)),
        headers: {
            accept: 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
